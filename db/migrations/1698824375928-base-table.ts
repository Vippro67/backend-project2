...
export class BaseTable1698824375928 implements MigrationInterface {
    name = 'BaseTable1698824375928'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`message\` CHANGE \`receiver_id\` \`receiver_id\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`message\` CHANGE \`group_id\` \`group_id\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`message\` CHANGE \`media_id\` \`media_id\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`comment\` CHANGE \`media_id\` \`media_id\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`comment\` CHANGE \`replied_comment_id\` \`replied_comment_id\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`comment\` CHANGE \`replied_comment_id\` \`replied_comment_id\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`comment\` CHANGE \`media_id\` \`media_id\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message\` CHANGE \`media_id\` \`media_id\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message\` CHANGE \`group_id\` \`group_id\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message\` CHANGE \`receiver_id\` \`receiver_id\` varchar(36) NULL DEFAULT 'NULL'`);
