...
export class BaseTable1701441632070 implements MigrationInterface {
    name = 'BaseTable1701441632070'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`post\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`user_id\` int NOT NULL, \`media_id\` int NULL, \`group_id\` int NULL, UNIQUE INDEX \`REL_049edb1ce7ab3d2a98009b171d\` (\`media_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
